...
const TestImages = lazy(() => import('@/pages/__dev__/TestImages'));
const MemberScheduleTest = lazy(() => import('@/pages/__dev__/MemberScheduleTest'));
...
const HelloAsso = lazy(() => import('@/pages/HelloAsso'));
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow w-full mx-auto px-4 py-8">
        <Routes>
          ...
          <Route path="/session-log/:id/live" element={<LazyRoute><LiveSession /></LazyRoute>} /> {/* Route for live session management */}
